...
领域规则的单元测试位于
[`tests/unit/test_goal.py`](../../../tests/unit/test_goal.py)、
[`tests/unit/test_planning.py`](../../../tests/unit/test_planning.py)、
[`tests/unit/test_execution.py`](../../../tests/unit/test_execution.py)、
[`tests/unit/test_checking.py`](../../../tests/unit/test_checking.py) 和
[`tests/unit/test_events.py`](../../../tests/unit/test_events.py)。完整探索闭环见
