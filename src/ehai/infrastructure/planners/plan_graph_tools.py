    ...
    "add_plan_edge": ToolDefinition(
        ...
        "Add one directed edge; dependency edges between nodes determine required dependencies.",
        {
            ...
            "properties": {
                ...
                "branch_key": {"oneOf": [_KEY_PROPERTY, {"type": "null"}]},
                "condition": {"oneOf": [_LABEL_PROPERTY, {"type": "null"}]},
            },
        },
    ),
    ...
    "set_plan_branch": ToolDefinition(
        ...
        "Create or replace one exploration branch, or remove it with remove=true.",
        {
            ...
            "properties": {
                ...
                "label": {"oneOf": [_LABEL_PROPERTY, {"type": "null"}]},
                "fork_node_key": {"oneOf": [_KEY_PROPERTY, {"type": "null"}]},
                "node_keys": {
                    "oneOf": [
                        {
                            "type": "array",
                ...
                "merge_node_key": {"oneOf": [_KEY_PROPERTY, {"type": "null"}]},
                "remove": {"type": "boolean"},
            },
        },
    ),
